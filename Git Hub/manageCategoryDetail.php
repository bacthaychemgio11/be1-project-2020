...
$productsList = $productsModel->getProductsByPageForCategory($page, $itemsPerPage, $idCategory, $sortType);
...
background: linear-gradient(90deg, rgba(30,36,0,0.981127485173757) 0%, rgba(238,236,10,1) 0%, rgba(0,255,119,1) 100%); padding: 10px 0">
                            ...
                            <div class="row rows-cols-2">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="admin.php">
                                                <form action="manageCategoryDetail.php?idCategory=<?= $idCategory ?>" method="get">
                                ...
                                <div class="col-md-4 d-flex justify-content-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="admin.php?idCategory=<?= $idCategory ?>">
                                                <form action="manageCategoryDetail.php?idCategory=<?= $idCategory ?>" method="get">
        ...
        <div class="wrap_pagination">
            ...
            $pagination->createPagesInCategoryPages_Admin($productsModel->countAllProductsHaveSameCateGory($idCategory), $itemsPerPage, $page, $idCategory, $sortType);
            ?>
        </div>
