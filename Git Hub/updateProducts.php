...
$updatedProduct = $productsModel->getProductByID($id);
...
// 23/12/2020
$message = "";
if (isset($_POST["product_name"]) && isset($_POST["product_description"]) && isset($_SESSION["admin"])) {
    ...
    // Thông báo upadte sản phẩm thành công!
    ...
    <div class="row">
        <div class="col-md-6">
            <strong>Your product was updated!</strong>
        </div>
        <div class="col-md-6" style="text-align: right;">
            <a href="manageProductDetail?idProduct=' . $id . '">
                Click here to see your updated product!
            </a>
        </div>
    </div>
    </div>';
...
<body>
    ...
    <div class="content">
        ...
        <div class="content1">
            <div class="container">
                <h1 style="font-family: Arial, Helvetica, sans-serif; color:red;">UPDATE PRODUCTS</h1>

                <!-- HIỂN THỊ THÔNG BÁO UPDATE SẢN PHẨM THÀNH CÔNG -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div style="padding: 50px 10px 50px 30px;">
                                <img src="./public/images/products/<?= $updatedProduct["product_photo"] ?>" class="img-fluid img-thumbnail" alt="">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div style="padding: 50px;">
                                <div style="padding: 50px; box-shadow: 1px 1px 10px 4px #ffff1c">
                                    <form action="updateproducts.php?idUpdate=<?= $id ?>" method="post" enctype="multipart/form-data">
                                        <!-- NAME -->
                                        <div class="form-group">
                                            <label for="name">Product name:</label>
                                            <input type="text" class="form-control" name="product_name" id="name" placeholder="Product name" value="<?= $updatedProduct["product_name"] ?>">
                                        </div>

                                        <!-- DESCRIPTION -->
                                        <div class="form-group">
                                            <label for="description">Product description:</label>
                                            <textarea class="form-control" name="product_description" id="description" rows="4"><?= $updatedProduct["product_description"] ?></textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="product_price" id="price" placeholder="Product price" min="0" value="<?= $updatedProduct["product_price"] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="product_quality" id="quality" min="0" max="5" value="<?= $updatedProduct["product_quality"] ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="product_state" id="state">
                                                        <option value="<?= $updatedProduct["product_state"] ?> ">
                                                            <?php
                                                            if ($updatedProduct["product_state"] == 0) {
                                                                echo "Out of Stock";
                                                            } else {
                                                                echo "In Stock";
                                                            }
                                                        ...
                                                        <option value="<?= 1 - $updatedProduct["product_state"] ?> ">
                                                            <?php
                                                            if ((1 - $updatedProduct["product_state"]) != 0) {
                                                                echo "In Stock";
                                                            } else {
                                                                echo "Out of Stock";
                                                            }
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="product_ispopular" id="state">
                                                        <option value="<?= $updatedProduct["product_ispopular"] ?> ">
                                                            <?php
                                                            if ($updatedProduct["product_ispopular"] == 0) {
                                                                echo "Common";
                                                            } else {
                                                                echo "Popular";
                                                            }
                                                        ...
                                                        <option value="<?= 1 - $updatedProduct["product_ispopular"] ?> ">
                                                            <?php
                                                            if ((1 - $updatedProduct["product_ispopular"]) == 0) {
                                                                echo "Common";
                                                            } else {
                                                                echo "Popular";
                                                            }
