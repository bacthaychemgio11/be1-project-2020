...
$updatedCategories = $categoriesModel->getCategoryName_By_IDCategory($id);

//XỬ LÝ UPDATE LOẠI SẢN PHẨM
// HỒ SĨ HÙNG
// 23/12/2020
$message = "";
if (isset($_POST["category_name"]) && isset($_SESSION["admin"])) {
    $categoriesModel->updateCategoriesByID(
        $id,
        $_POST["category_name"],
    );


    // Thông báo thêm loại sản phẩm thành công!
    ...
    <div class="row">
        <div class="col-md-6">
            <strong>Your category was updated!</strong>
        </div>
    </div>
    </div>';
}
...
<body>
    ...
    <div class="content">
        ...
        <div class="content1">
            <div class="container">
                <h1 style="font-family: Arial, Helvetica, sans-serif; color:red;">UPDATE CATEGORY</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div style="padding: 50px 10px 50px 30px;">
                                <img src="./public/images/categryicon.png ?>" class="img-fluid img-thumbnail" alt="">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div style="padding: 50px;">
                                <div style="padding: 50px;">
                                    <form action="updateCategory?idUpdate=<?= $id ?>" method="post" enctype="multipart/form-data">
                                        <!-- NAME -->
                                        <div class="form-group">
                                            <label for="name">Category name:</label>
                                            <input type="text" class="form-control" name="category_name" id="name" placeholder="Category name" value="<?= $updatedCategories ?>">
                                        </div> 
