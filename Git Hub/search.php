...
//Lấy dữ liệu
$productsList = $productsModel->getProductsByKeyWord($keyword, $page, $itemsPerPage, $sortType);
...
<style>
    ...
    /* HOVER IMAGE */
    .content .wrap_picture:hover img {
    ...
    <div class="content">
        ...
        <div class="content1">
            <div class="container">
                ...
                <!-- PRODUCT -->
                <!-- Menu Hiển thị danh sách sản phẩm thuộc Category đã chọn
        Thực hiện:
        Hồ Sĩ Hùng 27/11/2020 -->
                <div class="product">


                    <!-- HIỂN THỊ KẾT QUẢ TÌM KIẾM -->
                    <div class="category_Name" style="text-align: center; background-color :#61c29b; ">
                        <h2 style="text-transform: uppercase; color: white; padding: 10px 0;"><?= "SEARCHING RESULT" ?></h2>
                    </div>
...
background: linear-gradient(90deg, rgba(30,36,0,0.981127485173757) 0%, rgba(238,236,10,1) 0%, rgba(0,255,119,1) 100%); padding: 10px 0">
                            ...
                            <div class="col-md-4 d-flex justify-content-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="search.php?q=<?= $keyword ?>>">
                                            <form action="search.php?q=<?= $keyword ?>>" method="get">
        ...
        <div class="wrap_pagination">
            ...
            $pagination->createPagesInSearchPages($productsModel->countAllProductsHaveKeyWordInName($keyword), $itemsPerPage, $page, $keyword, $sortType);
            ?>
        </div>
