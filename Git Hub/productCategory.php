...
background: linear-gradient(90deg, rgba(30,36,0,0.981127485173757) 0%, rgba(238,236,10,1) 0%, rgba(0,255,119,1) 100%); padding: 10px 0">
                            ...
                            <div class="col-md-4 d-flex justify-content-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="productCategory.php?idCategory=<?= $idCategory ?>">
                                            <form action="productCategory.php?idCategory=<?= $idCategory ?>" method="get">
        ...
        <div class="wrap_pagination">
            ...
            $pagination->createPagesInCategoryPages($productsModel->countAllProductsHaveSameCateGory($idCategory), $itemsPerPage, $page, $idCategory, $sortType);
            ?>
        </div>
